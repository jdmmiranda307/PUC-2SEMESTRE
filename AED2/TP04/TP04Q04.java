...
public class TP04Q04{
    public static void main(String args[]){
        ...
        FilaSequencialSeries fila = new FilaSequencialSeries();
        ...
        for(int i = 0; i < numIn; i++){
            ...
            try{
                ...
                System.err.print("Erro na execucao" + e);
            }
            fila.mediaTemporadas();
        }
...
class FilaSequencialSeries {
    ...
    */
   public FilaSequencialSeries(int tamanho){
   ...
   public void mediaTemporadas(){
        int temporadas = 0;
        int elementos = 0;
        for(int i = primeiro; i != ultimo; i = ((i + 1) % series.length)){
            temporadas += series[i].getNumTemporadas();
            elementos++;
        }
        MyIO.println((int) Math.round((double)temporadas/elementos));
    }
}